...
```
![](https://github.com/CNXUXIN/database/blob/master/pictures/work1.1.png?raw=true)
![](https://github.com/CNXUXIN/database/blob/master/pictures/work1.2.png?raw=true)
...
```
![](https://github.com/CNXUXIN/database/blob/master/pictures/work2.1.png?raw=true)
# delete the table
```sql
...
5 rows in set (0.00 sec)
```
![](https://github.com/CNXUXIN/database/blob/master/pictures/work2.2.png?raw=true)
...
3 rows in set (0.00 sec)
```
![](https://github.com/CNXUXIN/database/blob/master/pictures/work2.3.png?raw=true)
...
3 rows in set (0.00 sec)
```
![](https://github.com/CNXUXIN/database/blob/master/pictures/work2.4.png?raw=true)
...
```
![](https://github.com/CNXUXIN/database/blob/master/pictures/work2.5.png?raw=true)
# Insert records
```sql
...
```
![](https://github.com/CNXUXIN/database/blob/master/pictures/work2.6.png?raw=true)
